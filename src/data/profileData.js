export const PROFILE_DATA = {
  ...
  tagline:
    "Manual & API Testing (Postman) | Web & Mobile Applications | Agile/Scrum | Frontend-Savvy QA (React.js)",
  ...
  metrics: [
    {
      ...
      value: "120+",
      detail:
        "Executed across multi-tier web applications with 100% coverage",
    },
    {
      label: "Defects Caught Early",
      value: "30+",
      detail:
        "Critical UI/UX & functional defects intercepted before release",
    },
    {
      label: "Defects Resolved",
      value: "50+",
      detail:
        "Logged, tracked, and closed through complete defect lifecycle",
    },
    {
      label: "Sprint Scope Coverage",
      value: "100%",
      detail:
        "Maintained rigorous test documentation aligned with sprint goals",
    },
  ],
  ...
  coreOfferings: [
    {
      ...
      desc:
        "Creating detailed test matrices, boundary value analyses, and exhaustive user workflows for web & mobile apps.",
      icon: "CheckCircle2",
    },
    {
      title: "API Testing with Postman",
      desc:
        "Validating REST endpoints, status codes, payload structures, and integration boundaries prior to UI consumption.",
      icon: "Network",
    },
    {
      title: "Bug Tracking & Defect Lifecycle",
      desc:
        "Logging reproducible bug tickets with console logs, network payloads, and pinpointing frontend state issues.",
      icon: "Bug",
    },
    {
      title: "Functional & Regression Testing",
      desc:
        "Executing comprehensive smoke, sanity, and regression passes to ensure zero regressions across release cycles.",
      icon: "ShieldAlert",
    },
    {
      title: "Agile/Scrum Ceremonies",
      desc:
        "Active participation in sprint planning, daily stand-ups, backlog grooming, and sprint retrospectives as embedded QA.",
      icon: "Users",
    },
    {
      title: "Frontend-Savvy Analysis (React.js)",
      desc:
        "Speaking developer language using HTML, CSS, JavaScript & React knowledge to bridge the gap between QA and Dev.",
      icon: "Code2",
    },
  ],
  ...
  education: [
    {
      ...
      focus:
        "Advanced Software Engineering, Systems Architecture, Quality Methodologies, and Database Systems",
    },
    {
      id: "edu-bca",
      ...
      focus:
        "Information Technology, Software Development, Web Technologies, Database Management",
    },
    {
      id: "edu-hssc",
      degree: "Higher Secondary School Certificate (HSSC)",
      institution:
        "The Kamakshi Education Society's Higher Secondary School of Arts Commerce and Science",
      location: "Curti, Ponda, Goa",
      period: "June 2018 - March 2020",
      focus:
        "Commerce Stream — Quantitative Analysis & Business Fundamentals",
    },
    {
      id: "edu-highschool",
      ...
      focus:
        "Foundational Academics, Science, Mathematics & Language",
    },
  ],
  ...
  certifications: [
    {
      ...
      category: "cloud",
      highlight:
        "Speech-to-text API integration, audio payload handling, and cloud services",
    },
    {
      id: "cert-cloud-genai",
      ...
      category: "ai",
      highlight:
        "Cloud infrastructure fundamentals, AI prompt patterns, and architecture",
    },
    {
      id: "cert-infoaid",
      ...
      category: "general",
      highlight:
        "Technical evaluation, software practices, and industry training",
    },
    {
      ...
      category: "ai",
      highlight:
        "Building interactive LLM-backed interfaces with Gemini models",
    },
    {
      id: "cert-appengine",
      ...
      category: "cloud",
      highlight:
        "Serverless web application deployment, scaling, and endpoint testing",
    },
  ],
  ...
  honors: [
    {
      title:
        "2nd Prize – State Level Intercollegiate Short Film Making Competition",
      significance:
        "Demonstrates precision, keen observational ability, storytelling, and an eye for micro-details — qualities that directly power thorough QA and defect analysis.",
    },
  ],
  ...
  sampleBugReport: {
    ...
    title:
      "Checkout Modal: Submitting without CVV freezes UI in pending state instead of showing inline validation",

    severity: "High",
    priority: "P1",

    environment:
      "Staging (Chrome 124.0, macOS 14.4 & Pixel 7 Android 14)",
    ...
    expectedResult:
      "Form validation should block submission immediately, display red error boundary on CVV input: 'Security code is required', and keep button enabled.",

    actualResult:
      "Button enters disabled 'Processing...' state with spinner, no validation message is shown, and the user cannot retry without refreshing the page.",

    devInsight:
      "Frontend state `isSubmitting` is set to `true` before form schema validation runs. In `PaymentForm.tsx`, `handleSubmit()` lacks a catch branch before dispatching the Redux action.",
