...
export const EducationCertifications = () => {
  return (
    <section
      id="education"
      className="py-20 bg-slate-900/40 border-t border-slate-800 relative"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-3 text-base text-slate-400">
            A strong foundation in computer applications, verified cloud
            credentials, and an eye for quality.
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-3 text-xs font-mono text-emerald-400 flex items-center gap-1.5">
                        ...
                        <span>
                          Quality is a mindset in both film and software.
                        </span>
                      </div>
                    </div>
                  </div>
