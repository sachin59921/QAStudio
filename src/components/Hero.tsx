    ...
    <section id="overview" className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-emerald-500/30 text-emerald-300 text-xs sm:text-sm font-medium mb-6 shadow-sm shadow-emerald-950/40">
          ...
          <span>Open to Opportunities: QA Engineer • QA Tester • QA Analyst (On-site / Hybrid / Remote)</span>
        </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            <div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white leading-tight">
                Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-400">{PROFILE_DATA.name}</span>
              </h1>
              <p className="mt-3 text-xl sm:text-2xl font-semibold text-slate-300 flex flex-wrap items-center gap-2">
                ...
                <span className="text-emerald-400 font-mono text-base font-normal">| Manual &amp; API Specialist</span>
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <span className="px-3 py-1 rounded-md text-xs font-medium bg-slate-900 border border-slate-800 text-slate-300 flex items-center gap-1.5">
                <Bug className="w-3.5 h-3.5 text-emerald-400" /> Manual Testing &amp; Bug Lifecycle
              </span>
              <span className="px-3 py-1 rounded-md text-xs font-medium bg-slate-900 border border-slate-800 text-slate-300 flex items-center gap-1.5">
                <Terminal className="w-3.5 h-3.5 text-teal-400" /> API Testing (Postman)
              </span>
              <span className="px-3 py-1 rounded-md text-xs font-medium bg-slate-900 border border-slate-800 text-slate-300 flex items-center gap-1.5">
                <Activity className="w-3.5 h-3.5 text-cyan-400" /> Agile/Scrum Ceremonies
              </span>
              <span className="px-3 py-1 rounded-md text-xs font-medium bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 flex items-center gap-1.5">
                <Code2 className="w-3.5 h-3.5 text-emerald-400" /> Frontend-Savvy QA (React.js)
              </span>
            </div>
            ...
            <div className="space-y-3.5 text-slate-300 leading-relaxed text-sm sm:text-base">
              <p>
                I make sure software products work the way users expect. At <span className="text-white font-semibold">SJ Innovation</span>, 
                I designed and executed functional, regression, and API test cases across web and mobile applications — validating releases, 
                tracking defects through their complete lifecycle, and partnering directly with developers to resolve them quickly.
              </p>
              <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 text-slate-300 text-sm">
                ...
                <p>
                  With my hands-on knowledge in <strong className="text-white">HTML, CSS, JavaScript, and React.js</strong>, I don't just report bugs — 
                  I speak developers' language. This translates to clearer root-cause isolation, faster fixes, reproducible network/state details, and fewer back-and-forth cycles.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-4">
            <div className="bg-slate-900/80 backdrop-blur-sm border border-slate-800 rounded-2xl p-6 shadow-xl relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 pb-5 border-b border-slate-800">
                ...
                <div>
                  <h3 className="font-bold text-lg text-white">{PROFILE_DATA.name}</h3>
                  <p className="text-xs text-emerald-400 font-medium">Software QA Engineer</p>
              ...
              <div className="py-4 space-y-3">
                ...
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-slate-950/70 border border-slate-800/80 group">
                  <div className="flex items-center gap-2.5 overflow-hidden">
                    ...
                    <div>
                      <div className="text-[10px] text-slate-400 uppercase font-mono">Mobile / WhatsApp</div>
                      <a 
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <div className="text-[10px] text-slate-400 uppercase font-mono">Live Portfolio URL</div>
              ...
              <div className="mt-2 pt-4 border-t border-slate-800">
                ...
                <p className="text-xs text-slate-400 italic">
                  "I won 2nd Prize at a state-level intercollegiate short film competition. Quality, it turns out, is a mindset."
                </p>
              </div>
            </div>
          </div>
