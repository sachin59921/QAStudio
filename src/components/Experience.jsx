...
import { Briefcase, Calendar, MapPin, CheckCircle2, ChevronRight, Layers, Bug, Terminal, Users } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-3 text-base text-slate-400">
            Hands-on QA engineering, multi-sprint test coverage, API verification, and direct developer collaboration.
          </p>
        </div>

        {/* Timeline Stack */}
        <div className="space-y-10">
          {PROFILE_DATA.experiences.map((exp, expIdx) => (
            <div
              key={exp.id}
            ...
            >
              ...
              {/* Core Deliverables / Bullet points from PDF */}
              <div className="mt-6">
              ...
              <div className="mt-6 pt-5 border-t border-slate-800/80 flex flex-wrap items-center gap-2">
                <span className="text-xs text-slate-500 font-mono mr-1">Skills &amp; Focus:</span>
